...
\input{markdown/Florian.md/Abgrenzung.md}
...
\input{markdown/Florian.md/Hardware.md}
...
\renewcommand{\kapitelautor}{Autor: Dominik Nußbaumer}
    ...
    \input{markdown/Dominik.md/Frontend.md}

\section{Responsives Design}\label{Responsives Design}

\renewcommand{\kapitelautor}{Autor: Dominik Nußbaumer}

    \input{markdown/Dominik.md/responsive_design.md}

\section{CSS}\label{CSS}

\renewcommand{\kapitelautor}{Autor: Dominik Nußbaumer}

    \input{markdown/Dominik.md/Flexbox.md}

    \input{markdown/Dominik.md/CSSGrid.md}

    \input{markdown/Dominik.md/Grid_vs_Flexbox.md}

    \input{markdown/Dominik.md/normalize.md}

\section{SASS}\label{SASS}

\renewcommand{\kapitelautor}{Autor: Dominik Nußbaumer}

    \input{markdown/Dominik.md/SASS.md}
...
\renewcommand{\kapitelautor}{Autor: Dominik Nußbaumer}
    ...
    \input{markdown/Dominik.md/jQuery.md}

\section{Design}\label{Design}

\renewcommand{\kapitelautor}{Autor: Dominik Nußbaumer}

    \input{markdown/Dominik.md/UX_Fokus_auf_technisch_unversierte_Benutzer.md}
...
\input{markdown/Florian.md/Beleuchtungskonzept.md}
