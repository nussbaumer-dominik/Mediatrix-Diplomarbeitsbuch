...
![derzeitige Darstellung ohne Flexbox \label{ohne_flex}](bilder/Dominik/Flexbox_example1.pdf){width=90%}
...
![Layout mit _display: flex_ \label{mit_flex}](bilder/Dominik/Flexbox_example2.pdf){width=90%}
