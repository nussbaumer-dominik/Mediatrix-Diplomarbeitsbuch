...
\chapter*{Kurzfassung}
\input{markdown/Dominik.md/Kurzfassung.md}

\chapter*{Abstract}
\selectlanguage{english}
\input{markdown/Dominik.md/Abstract.md}
...
\input{markdown/Clemens.md/problemstellung.md}
...
\input{markdown/Clemens.md/Sicherheit.md}
...
\input{markdown/Clemens.md/ola.md}

\section{WiringPi}\label{WiringPi}

\renewcommand{\kapitelautor}{Autor: Clemens Scharwitzl}

\input{markdown/Clemens.md/wiringPi.md}
...
\input{markdown/Clemens.md/jwt.md}

\section{SQLite}\label{SQLite}

\renewcommand{\kapitelautor}{Autor: Clemens Scharwitzl}

\input{markdown/Clemens.md/sqlite.md}
...
\chapter{Frontend}\label{Frontend}
    ...
    \input{markdown/Dominik.md/Frontend.md}{Autor: Dominik Nußbaumer}

\section{CSS}\label{CSS}

\renewcommand{\kapitelautor}{Autor: Dominik Nußbaumer}

    \input{markdown/Dominik.md/Flexbox.md}{Autor: Dominik Nußbaumer}

    \input{markdown/Dominik.md/CSSGrid.md}{Autor: Dominik Nußbaumer}

    \input{markdown/Dominik.md/Grid_vs_Flexbox.md}{Autor: Dominik Nußbaumer}

    \input{markdown/Dominik.md/normalize.md}{Autor: Dominik Nußbaumer}

\section{jQuery}\label{jQuery}

    \input{markdown/Dominik.md/jQuery.md}{Autor: Dominik Nußbaumer}

\section{SASS}\label{SASS}

    \input{markdown/Dominik.md/SASS.md}{Autor: Dominik Nußbaumer}

\section{CSS-Variablen}\label{CSS-Variablen}

    \input{markdown/Dominik.md/CSS_Variablen.md}{Autor: Dominik Nußbaumer}

\section{Responsives Design}\label{Responsives Design}

    \input{markdown/Dominik.md/responsive_design.md}{Autor: Dominik Nußbaumer}

\section{Design}\label{Design}

    \input{markdown/Dominik.md/UX_Fokus_auf_technisch_unversierte_Benutzer.md}{Autor: Dominik Nußbaumer}
